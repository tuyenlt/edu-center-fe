        ...
        <div className="max-w-7xl mx-auto px-4 py-24 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-lg md:text-xl">
              Start learning English with our expert teachers and interactive
              lessons.
            </p>
            <Button
              className="bg-white text-blue-600 hover:bg-gray-100"
            ...
            {[
              {
                ...
                desc: 'Learn from qualified and experienced teachers.',
              },
              {
                title: 'Flexible Schedule',
                desc: 'Choose class times that suit your availability.',
              },
              {
                title: 'Interactive Lessons',
                desc: 'Engage in live discussions and practice ease.',
              },
            ].map((f, i) => (
            ...
            {[
              {
                ...
                avatar: '/avatar1.jpg',
                quote:
                  'The teachers are very supportive and the lessons are engaging.',
              },
              {
                name: 'Jire Improveed',
                avatar: '/avatar2.jpg',
                quote: 'Flexible schedule helped me learn at my own pace.',
              },
            ].map((t, i) => (
