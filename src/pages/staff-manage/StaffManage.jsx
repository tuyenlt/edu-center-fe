...
export default function StaffManage() {
	...
	const handleAddStaff = async (e) => {
		...
		if (!newName.trim() || !newEmail.trim() || !newPassword || !newPasswordConfirm) {
			...
			<div className="w-full flex items-center mb-4">
				<div className="flex items-center w-full gap-2">
					<Input
						...
						className="w-full"
					/>
					<Button onClick={handleSearch} className="btn btn-primary" variant="outline">
						Search
					</Button>
					<Button
						variant="outline"
			...
			{addStaffOpen && (
				<div className="fixed inset-0 z-50 flex items-center justify-center">
					...
					<div className="relative bg-white rounded-lg shadow-lg w-[90vw] max-w-md mx-auto p-6">
						...
						<h2 className="text-xl font-semibold mb-4">Add New Staff Account</h2>
